"""OTEL + audit-sdk wiring for agent-compliance-assistant.
...
SERVICE_NAME = "agent-compliance-assistant"
SERVICE_VERSION = "0.1.0"
EVENT_TYPE = "agent.compliance.invoked"
ENTITY_TYPE = "compliance_query"
...
async def emit_invocation(
    *,
    ...
    """Best-effort: publish ``agent.compliance.invoked``."""
