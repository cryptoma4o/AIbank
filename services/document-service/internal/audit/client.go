...
// document-service.  Lazy singleton.
//
// Интеграция следует ADR-0010: загрузка документа фиксируется в audit log
// для compliance (115-ФЗ § 7) и для биллинга (per-event тарификация).
package audit
