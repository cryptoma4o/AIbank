...
// createTenantSchema creates a fresh tenant schema and applies the
// per-tenant SQL migrations under `tenantMigrationsDir` to it. Used by
// tests that exercise applicant CRUD via search_path.
