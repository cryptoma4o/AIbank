"""OTEL + audit-sdk wiring for agent-conversational.
...
SERVICE_NAME = "agent-conversational"
SERVICE_VERSION = "0.1.0"
EVENT_TYPE = "agent.conversational.invoked"
...
async def emit_invocation(
    *,
    ...
    """Best-effort: publish ``agent.conversational.invoked``."""
