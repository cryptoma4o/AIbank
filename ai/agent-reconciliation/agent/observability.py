"""OTEL + audit-sdk wiring for agent-reconciliation.
...
SERVICE_NAME = "agent-reconciliation"
SERVICE_VERSION = "0.1.0"
EVENT_TYPE = "agent.reconciliation.invoked"
...
async def emit_invocation(
    *,
    ...
    """Best-effort: publish ``agent.reconciliation.invoked``."""
