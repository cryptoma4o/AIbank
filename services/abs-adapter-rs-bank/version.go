// Package adapterrsbank — корневой пакет модуля aibank/abs-adapter-rs-bank.
//
...
// `services/abs-adapter-rs-bank/VERSION` — единственный источник правды).
//
