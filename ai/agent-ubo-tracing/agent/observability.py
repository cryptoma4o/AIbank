"""OTEL + audit-sdk wiring for agent-ubo-tracing.
...
SERVICE_NAME = "agent-ubo-tracing"
SERVICE_VERSION = "0.1.0"
EVENT_TYPE = "agent.ubo_tracing.invoked"
ENTITY_TYPE = "ubo_trace"
...
async def emit_invocation(
    *,
    ...
    """Best-effort: publish ``agent.ubo_tracing.invoked``."""
